<?php
/* Smarty version 3.1.32, created on 2018-08-01 15:15:53
  from '/var/www/BackupManagement/templates/admin/Phistory.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b61b289eebca4_20116747',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f8e3fb67ec2259483a656a06b5f67cd278785c33' => 
    array (
      0 => '/var/www/BackupManagement/templates/admin/Phistory.tpl',
      1 => 1533129353,
      2 => 'file',
    ),
  ),
...
function content_5b61b289eebca4_20116747 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block sidebar bg-blue">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link text-white blueac" href="index.php?page=HistoricsBackup">
					<i class="far fa-history"></i> Historique des sauvegardes
                </a>
              </li>			  
			  <li class="nav-item">
                <a class="nav-link text-white" href="index.php?page=Psettings">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
				<h1 class="h2">Historique des sauvegarde</h1>
			</div>
			<div id="listeSire">
				<?php
