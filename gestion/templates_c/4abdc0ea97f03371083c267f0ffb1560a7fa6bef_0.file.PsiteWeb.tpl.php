<?php
/* Smarty version 3.1.32, created on 2018-08-03 15:49:11
  from '/var/www/BackupManagement/templates/admin/PsiteWeb.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b645d57540f71_18263739',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4abdc0ea97f03371083c267f0ffb1560a7fa6bef' => 
    array (
...
function content_5b645d57540f71_18263739 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
?>
							<tr>
								...
								<td>
									<input type="hidden" class="form-control" name="idSite" id="idSite" value="<?php echo $_smarty_tpl->tpl_vars['foo']->value['id'];?>
">
									<button id="backupManual" title="Lancer une backup" class="btn"><i class="fas fa-file-download"></i></button>
...
>	
		...
		$("#backupManual").click(function(e){
			e.preventDefault();
			$("#backupManual").prop("disabled",true);
			$.ajax({
				type: "POST",
				url: "backup.php",
				data:{
				...
				{
					eval(data); // show response from the php script.
					$("#backupManual").prop("disabled",false);
				}
			});
		});
