<?php
/* Smarty version 3.1.32, created on 2018-08-01 15:55:03
  from '/var/www/BackupManagement/templates/admin/Pbackup.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b61bbb7a778c1_23183632',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7d1ed948c6ea1a696c6be17a522066dc186e8437' => 
    array (
      0 => '/var/www/BackupManagement/templates/admin/Pbackup.tpl',
      1 => 1533131699,
      2 => 'file',
    ),
  ),
...
function content_5b61bbb7a778c1_23183632 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block sidebar bg-blue">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link text-white blueac" href="tinyfilemanager.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
				<h1 class="h2">Gestion des backups</h1>
			</div>
			<div class="row">			
			</div>
        </main>
